...
{
	.description = "Modular Exponentiation (mod=128, base=20, exp=3, res=128)",
...
{
	.description = "Modular Exponentiation (mod=60, base=50, exp=40, res=60)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=8, base=65, exp=17, res=8)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=100, base=150, exp=192, res=100)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=255, base=20, exp=10, res=255)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=112, base=257, exp=43, res=112)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=299, base=240, exp=321, res=299)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=448, base=50, exp=40, res=448)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
...
{
	.description = "Modular Exponentiation (mod=19, base=500, exp=35, res=19)",
	.xform_type = RTE_CRYPTO_ASYM_XFORM_MODEX,
	.base = {
		.data = {
